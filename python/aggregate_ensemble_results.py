        ...
        runs.append(
            {
                ...
                "mu_al_al": float(params.get("mu_Al_Al", "nan")),
                "mu_al_diamond": float(params.get("mu_Al_Diamond", "nan")),
                "mu_diamond_diamond": float(params.get("mu_Diamond_Diamond", "nan")),
                ...
                "stage_settle_steps": int(float(params.get("stage_settle_steps", "0"))),
                "final_settle_steps": int(float(params.get("final_settle_steps", "0"))),
                "p95_mpa": p95,
                "curve": curve_rows,
            }
        )
