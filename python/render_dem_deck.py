...
def model_parameter_block(
    ...
    lines.extend(
        [
            ...
            f'print           "top_velocity_cm_s,{args.top_vel_cm_s:.9g},cm/s" append DEM/model_parameters.csv screen no',
            f'print           "time_step_seconds,{args.dt_seconds:.9g},s" append DEM/model_parameters.csv screen no',
            f'print           "initial_settle_steps,{args.initial_settle_steps},step" append DEM/model_parameters.csv screen no',
            f'print           "stage_settle_steps,{args.stage_settle_steps},step" append DEM/model_parameters.csv screen no',
            f'print           "final_settle_steps,{args.final_settle_steps},step" append DEM/model_parameters.csv screen no',
