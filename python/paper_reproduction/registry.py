...
PAPER_TARGETS = [
    PaperTarget(
        ...
        acceptance_gates=[
            ...
            "contact_participation increasing or review for complete uncalibrated direct-force demo",
            "force_chain_strength_inhomogeneity_d1 decreasing or review for complete uncalibrated direct-force demo",
    ...
    PaperTarget(
        ...
        paper_methods=[
            ...
            "temperature-dependent diffusion-law neck-growth calculation",
        ],
        reproduced_algorithms=[
            "compaction curve generator",
            "Heckel, Huang, and Kawakita fit functions",
            "contact electrical-thermal network",
            "force-current and Joule heat-diffusion-neck correlation checks",
        ],
        calibration_targets=[
        ...
        acceptance_gates=[
            ...
            "Joule heat-diffusion-neck correlation positive",
        ],
        current_backend="proxy compaction plus electrothermal coupling and normalized diffusion-law neck growth",
        next_backend_steps=[
            "calibrate contact conductance from contact radius or force law",
            "calibrate diffusion constants and activation energies against alloy-specific sintering data",
    ...
    PaperTarget(
        ...
        paper_methods=[
            ...
            "Cu/Fe interface friction and Cu-wall friction decrease with Cu content",
            "temperature effect weakens after large pores vanish above about 500 MPa",
            "100-particle and 197-particle models converge after 500 MPa",
            "coated shell as softer, more conductive deformation path",
        ],
        reproduced_algorithms=[
            "equivalent coated-powder parameter sweep generator",
            "core-shell composition metrics for density, stress uniformity, plasticity, and friction proxies",
            "temperature-pressure response table with high-pressure attenuation",
            "100-particle versus 197-particle convergence table",
        ...
        calibration_targets=[
            ...
            "Cu20@Fe80 lowers stress nonuniformity relative to Fe",
            "increasing Cu content lowers Cu/Fe and Cu-wall friction",
            ...
            "100-particle and 197-particle densities converge by 600 MPa",
        ],
        expected_outputs=[
            "li/li_coated_powder_sweeps.csv",
            "li/li_core_shell_metrics.csv",
            "li/li_temperature_pressure_response.csv",
            "li/li_particle_count_convergence.csv",
        ...
        acceptance_gates=[
            ...
            "Cu30@Fe70 > Cu20@Fe80 > Cu10@Fe90 > Fe density ranking",
            "Cu20@Fe80 stress is more uniform than Fe",
            "Cu/Fe interface and Cu-wall friction decrease with Cu content",
            "temperature effect weakens after 500 MPa",
            "100-particle and 197-particle models converge at high pressure",
        ],
        current_backend="equivalent core-shell material/process proxy plus convergence tables",
        next_backend_steps=[
