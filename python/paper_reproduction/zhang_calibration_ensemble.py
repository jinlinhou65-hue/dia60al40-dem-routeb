            ...
            rows.append(
                {
                    ...
                    "mu_al_al": optional_float(params.get("mu_Al_Al")),
                    "mu_al_diamond": optional_float(params.get("mu_Al_Diamond")),
                    "mu_diamond_diamond": optional_float(params.get("mu_Diamond_Diamond")),
