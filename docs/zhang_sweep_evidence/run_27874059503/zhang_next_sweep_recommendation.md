...
- Status: `ready`
- Selected artifact: `dia60al40-dem-artifacts-sizeC-Emax44.772-mu0.654-seed2`
...
p95=634 MPa is inside Zhang's 572-638 MPa endpoint window and the force-chain trend candidate passes, so hold the best mu/E pair fixed and validate robustness across seeds and diamond size cases
