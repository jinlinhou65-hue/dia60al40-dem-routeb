...
- Status: `ready`
- Selected artifact: `dia60al40-dem-artifacts-sizeE-Emax37.517-mu0.693-seed2`
...
p95=604 MPa is inside Zhang's 572-638 MPa endpoint window and the force-chain trend candidate passes, so hold the best mu/E pair fixed and validate robustness across seeds and diamond size cases
