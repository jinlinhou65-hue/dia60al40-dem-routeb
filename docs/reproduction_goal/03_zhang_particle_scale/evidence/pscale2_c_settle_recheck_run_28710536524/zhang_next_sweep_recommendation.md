...
- Selected artifact: `dia60al40-dem-artifacts-sizeC-pscale2-Emax72.581-mu0.654-seed0-settle4`
...
only 1/5 seed/size rows both pass Zhang trend gates and fall inside the 572-638 MPa endpoint window, so one global mu/E pair is not robust
...
```json
{
  ...
  "e_al_emax_sweep_json": "[\"72.581\", \"76.774\"]",
  "mu_scale_json": "[\"0.589\", \"0.654\"]",
