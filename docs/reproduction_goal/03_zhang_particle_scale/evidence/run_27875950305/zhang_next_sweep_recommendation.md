...
- Status: `ready`
- Selected artifact: `dia60al40-dem-artifacts-sizeC-pscale2-Emax44.772-mu0.654-seed2`
...
p95=412 MPa is below Zhang's 572-638 MPa endpoint window, so sweep higher Al endpoint modulus; a Zhang trend candidate exists, so keep a narrow friction bracket
